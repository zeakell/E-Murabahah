...
<head>
    ...
    <title>Daftar | KOSIKA TAZKIA</title>
...
<div class="login-form">
    ...
    <form action="regis_process.php" method="post" role="form" class="contactForm">
        <h4 class="text-center">
        <img src="img/KOSIKA.png" width="100" height="100" /><br>Daftar Akun</h4><br>
        ...
        <div class="form-group">
            <input type="text" class="form-control" placeholder="nama_nasabah" name="nama_nasabah" id="nama_nasabah" required="required">
        </div> 
